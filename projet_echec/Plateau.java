...
class Plateau{
	...
	this.ajouterPiece(new Tavalier('B', new Position("A3")));
	this.ajouterPiece(new Tavalier('B', new Position("H3")));
	...
	this.ajouterPiece(new Tavalier('N', new Position("A6")));
	this.ajouterPiece(new Tavalier('N', new Position("H6")));
    }
